...
1.0 - Purge "It's X, not Y" types of constructs. These are click-bait and low quality reversal types of constructs. They suck. For example: "Hard evidence, not soft scoring."
