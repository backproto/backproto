...
```typescript
import { openclaw, getAddresses } from "@backproto/sdk";
...
The discount is computed on-chain via `getOpenClawStakeDiscount` and applies across all Backproto domains (relay, lightning, and agent services).
...
Source: [github.com/backproto/backproto/tree/main/agent-explorer](https://github.com/backproto/backproto/tree/main/agent-explorer).
