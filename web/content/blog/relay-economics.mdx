...
Relay.Gold ([relay.gold](https://relay.gold)) shows registered relays, their composite capacity scores, and current anti-spam minimums. The source is at [github.com/backproto/backproto/tree/main/relay-dash](https://github.com/backproto/backproto/tree/main/relay-dash).
