  ...
  return (
    <div className={styles.layout}>
      ...
      <h1 className={styles.heading}>
        <Image src="/pura.png" width={40} height={40} alt="" style={{ borderRadius: 8 }} />
      ...
      <p>
        ...
        allocation. Beyond AI agents, Pura extends to these research domains:
      </p>
      ...
      <p>
        Pura implements this as the <strong>DemurrageToken</strong>, a token
      ...
      <p>
        Pura adds a <strong>real-time capacity signaling layer</strong> for
      ...
      <p>
        Pura adds an economic layer for Nostr relays using the same BPE
        primitives:
      </p>
      <ol>
        <li>
      ...
      <p>
        ...
        decentralized storage or compute marketplaces) can plug into Pura by
      ...
      <p>
        The platform layer is what turns Pura from &quot;a routing protocol
      ...
      <p>
        Pura adds an economic coordination layer for OpenClaw agent
      ...
      <ul>
        <li>
          ...
          a research agent, Pura routes to the agent with the most verified
        ...
        <li>
          ...
          stage to available agents using Pura&apos;s Pipeline contract
        </li>
      </ul>
      <p>
        <strong>The sidecar model</strong>: Pura does not modify
        OpenClaw&apos;s core. Agents opt in by installing a Pura
      ...
      <p>
        ...
        where Pura directly contributes. Here&apos;s the full picture.
      </p>
      ...
      <h3 id="pura-adds">What Pura adds</h3>
      <p>Pura provides three things the Lightning ecosystem currently lacks:</p>
      <p>
      ...
      <p>
        Critically, Pura <strong>does not modify the Lightning
      ...
      <p>
        ...
        conservative about protocol changes. Pura offers improved routing
      ...
      <p>
        ...
        proportional to verified capacity, Pura makes routing more
