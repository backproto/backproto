---
title: Why splitting stake doesn't pay
date: "2026-03-16"
description: Stake-bounded capacity caps create economic friction against identity splitting — but not a hard block
---
...
The stake-based approach does not eliminate Sybil attacks. Splitting stake across addresses does increase raw aggregate capacity — that much is true. What it cannot do is increase capacity without increasing the obligation to perform work. An attacker who wants to capture 3x the payment flow needs to do 3x the work and risk 3x the stake in independent slashing pools. At that point they are just running a larger service, not gaming the protocol.
