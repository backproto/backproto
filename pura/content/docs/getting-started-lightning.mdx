...
```typescript
import { registerNode } from '@pura/sdk/actions/lightning'
import { stake } from '@pura/sdk/actions/stake'
...
```typescript
import { signCapacityAttestation } from '@pura/sdk/signing'
...
```typescript
import { joinRoutingPool } from '@pura/sdk/actions/lightning'
...
import { getOptimalRoute, getSmoothedCapacity, getRoutingFee }
  from '@pura/sdk/actions/lightning'
...
```typescript
import { rebalanceRoutingPool } from '@pura/sdk/actions/lightning'
...
```typescript
import { isProtocolAvailable } from '@pura/sdk/actions/platform'
