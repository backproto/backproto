...
An agent-based simulation validates the theoretical claims of [BPE](/docs/contracts). The simulation models a multi-source, multi-sink economy with heterogeneous agent capacities and task types.
...
Simulation source is on [GitHub](https://github.com/puraxyz/puraxyz/tree/main/simulation/bpe_sim.py).

---

## See also

- [Smart Contracts](/docs/contracts) — All 32 deployed contracts with addresses and source
- [TypeScript SDK](/docs/sdk) — Type-safe client for interacting with contracts
