...
This is a summary of the full [NIP-XX specification](https://github.com/pura-xyz/pura/blob/main/docs/nips/NIP-XX-backpressure-relay-economics.md).
...
```typescript
import * as relay from "@pura/sdk/actions/relay";
...
The complete NIP-XX specification with all protocol details, message formats, and implementation requirements is in the [docs/nips](https://github.com/pura-xyz/pura/blob/main/docs/nips/NIP-XX-backpressure-relay-economics.md) directory.
