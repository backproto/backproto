...
3.  **Protocol design** (Protocol Design): We implement BPE using Superfluid's General Distribution Agreement (GDA) on Base, with commit-reveal capacity signaling, stake-bounded capacity with Sybil friction, and multi-stage pipeline composition.
